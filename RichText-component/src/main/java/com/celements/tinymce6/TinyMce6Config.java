...
public class TinyMce6Config implements RteConfigRole {

  private static final Logger LOGGER = LoggerFactory.getLogger(TinyMce6Config.class);
  ...
  private static final ImmutableList<String> CELIMAGE = ImmutableList.of("image");
  private static final ImmutableList<String> CELLINK = ImmutableList.of("link");
  ...
  private static final ImmutableMap<String, List<String>> initButtonConversionMap() {
    return ImmutableMap.<String, List<String>>builder().put("celimage", CELIMAGE).put("advimage",
        CELIMAGE).put("separator", ImmutableList.of(SEPARATOR)).put("advlink", CELLINK)
        .put("cellink", CELLINK)
